...
export default function InternationalPatientBookAnAppointmentPage() {
    return (
        <>
        ...
        <Header />
            ...
            <main className="international book-an-appointment-page">
                <section className="p_100 book-an-appointment-form_section">
                    <div className="container">
            ...
            <!--</div>--> */}
                        <div className="contact_right">
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="contact_input">
                                        <input type="time" className="form-control" value="12:00:00" />
                                    </div>
                                </div>
