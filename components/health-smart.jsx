...
export default function HealthSmartPage(){
    return(
        <>
    ...
    <div className="container">
        <div className="table_data table-responsive">
            <table className="table table-striped table-bordered caption-top">
                <caption className="text-center">Jaypee Health Smart / Jaypee Health Times</caption>
                <thead className="table_head">
                    <tr>
                        <th>Sr. No.</th>
                        <th>Health Smart Magazines </th>
                        <th>Download</th>
                    </tr>
                ...
                <tr>
                    <td>1</td>
                    <td>Jaypee Health Times April-May 2019</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/jaypee-health-times-april-may-2019.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Jaypee Health Times Oct-Nov 2018</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/jaypee-health-times-nov-2018.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>3</td>
                    <td>Jaypee Health Times March-April 2018</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/Jaypee Health Times_27th March_AW.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>4</td>
                    <td>Jaypee Health Times January-February 2018</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/Newspaper Jaypee-4 Jan-02.pdf" className="download_pdf_icon"></a></td>
                </tr>
        
                <tr>
                    <td>5</td>
                    <td>Jaypee HealthSmart July 2017</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/July 2017.pdf" className="download_pdf_icon"></a></td>
                </tr>
        
                <tr>
                    <td>6</td>
                    <td>Jaypee HealthSmart June 2017</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/June 2017.pdf" className="download_pdf_icon"></a></td>
                </tr>
                  <tr>
                    <td>7</td>
                    <td>Jaypee HealthSmart May 2017</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/May 2017.pdf" className="download_pdf_icon"></a></td>
                </tr>
                   <tr>
                    <td>8</td>
                    <td>Jaypee HealthSmart April 2017</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/April 2017.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>9</td>
                    <td>Jaypee HealthSmart March 2017</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/11_Jaypee_Health_Smart_March_2017.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>10</td>
                    <td>Jaypee HealthSmart February 2017</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/10_Jaypee_Health_Smart_Feb_2017.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>11</td>
                    <td>Jaypee HealthSmart January 2017</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/09_Jaypee_Health_Smart_Jan_2017.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>12</td>
                    <td>Jaypee HealthSmart December 2016</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/08_Jaypee_Health_Smart_December_2016.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>13</td>
                    <td>Jaypee HealthSmart November 2016</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/07_Jaypee_Health_Smart_November_2016.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>14</td>
                    <td>Jaypee HealthSmart October 2016</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/06_Jaypee_Health_Smart_October_2016.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>15</td>
                    <td>Jaypee HealthSmart September 2016</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/05_Jaypee_Health_Smart_September_2016.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>16</td>
                    <td>Jaypee HealthSmart August 2016</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/04_Jaypee_Health_Smart_August_2016.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>17</td>
                    <td>Jaypee HealthSmart July 2016</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/03_Jaypee_health_smart_July_2016.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>18</td>
                    <td>Jaypee HealthSmart June 2016</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/02_Jaypee_HealthSmart_June_2016.pdf" className="download_pdf_icon"></a></td>
                </tr>
                <tr>
                    <td>19</td>
                    <td>Jaypee HealthSmart May 2016</td>
                    <td><a target="_blank" href="https://www.jaypeehealthcare.com/sites/default/files/pdf/01_Jaypee_HealthSmart_-_May_2016.pdf" className="download_pdf_icon"></a></td>
                </tr>
                </tbody>
            </table>
        </div>
