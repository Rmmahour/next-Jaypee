...
export default function SingleServicePage() {
    return (
        ...
        <Header />
            <main>
                ...
                <section className="service_top_tabs">
                    <div className="container">
                        <div className="nav_inner">
                            <nav className="navigation service_list" id="mainNav">
                                <a className="navigation__link" href="#overview">Overview</a>
                                <a className="navigation__link" href="#service_dr">Doctors</a>
                                <a className="navigation__link" href="#testimonials">Testimonials</a>
                                <a className="navigation__link" href="#health_blogs">Health Blogs</a>
                            </nav>
                        </div>
                    </div>
                </section>
                ...
                <section className="service_page">
                    <div className="doc_single_data">
                        <div className="service-tab" id="overview">
                            <div className="service_overview p_100">
                                <div className="container">
                                    <div className="speciality_tabs_grid">
                                        <div className="left">
                    ...
                    <div className="service-tab" id="service_dr">
                        <div className="service_dr p_100">
                            <div className="container">
                    ...
                    <div className="service-tab" id="testimonials">
                        <div className="service_testimonial p_100">
                            <div className="container">
                                <div className="main_heading">
                                    <h2>Testimonials</h2>
                                </div>
                    ...
                    <div className="service-tab" id="health_blogs">
                        <div className="service_blogs p_100">
                            <div className="container">
                                <div className="main_heading">
                                    <h2>Health Blogs</h2>
                                </div>
    ...
    <section className="service_overview p_100">
    ...
    <section className="service_dr p_100">
    ...
    <section className="service_testimonial p_100">
        <div className="container">
            <div className="dr_blogs">
    ...
    <section className="service_blogs p_100">
        <div className="container">
            <div className="dr_blogs">
                <h2>Doctor’s Blogs</h2>
