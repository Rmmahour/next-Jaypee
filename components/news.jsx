...
export default function NewsPage() {
    return (
        ...
        <Header />
            ...
            <section className="news-post-main-sec p_100">
                <div className="container">
                    <div className="row">
                        <div className="col-7">
                            <div className="news-post-left-box">
                                <img src="Noida 1_0.jpeg" alt="news post" />
                                    <div className="news-post-content-left">
                                        <p>News Mar 01, 2024</p>
                                        <h4>जेपी हॉस्पिटल ने किये 1000 से अधिक सफल किडनी ट्रांस्लाट</h4>
                        ...
                        <div className="col-5">
                            ...
                            <div className="right_news_grid">

                                <div className="news-post-right-box">
                                    <div className="row">
                                        <div className="col-5">
                                            <img src="Noida 1_0.jpeg" />
                                        </div>
                                        <div className="col-7">
                                            <div className="news-post-content">
                                                ...
                                                <div className="news-post-title">
                                                    <h5>
                                                        जेपी हॉस्पिटल ने किये 1000 से अधिक सफल किडनी ट्रांसप्लांट
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
            ...
            <section className="main-news-sec">
                <div className="container">
                    <div className="row">
                        <ul className="news-inner-sec">
                            <li>
                                <div className="news-box">
                                    <h5>जेपी हॉस्पिटल ने किये 1000 से अधिक सफल किडनी ट्रांसप्लांट ्लांट</h5>
                                    <img src="Noida 1_0.jpeg" alt="news image" />
                                </div>
                            </li>
                            <li>
                                <div className="news-box">
                                    <h5>जेपी हॉस्पिटल ने किये 1000 से अधिक सफल किडनी ट्रांसप्लांट</h5>
                                    <img src="Noida 1_0.jpeg" alt="news image" />
                                </div>
                            </li>
                            <li>
