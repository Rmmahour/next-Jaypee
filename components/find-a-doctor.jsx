...
export default function FindADoctorPage(){
    return(
        ...
        <Header />
        <section className="bread_sec inner find_dr">
            ...
            <div className="filter_grid">
                <div className="filter_box">
                    <div className="filter_drop">
                        <select className="form-select" id="filter_speciality" aria-label="Default select example">
                            <option selected vlaue="all">Speciality or Program</option>
                ...
                <div className="filter_box">
                    <div className="filter_drop">
                        <select className="form-select" id="filter_department" aria-label="Default select example">
                ...
                <div className="filter_box">
                    ...
                    <!--        <input id="search_field" type="text" className="form-control" aria-label="Search by Name input" placeholder="Search by Name">-->
                    <!--        <button className="input-group-text bg-primary" id="inputGroup-sizing-default">-->
                    <!--            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">-->
...
<section className="doctors_sec p_100">
    <div className="container">
                        ...
                        <a href="#" className="profile_btn">
                            <svg width="36" height="26" viewBox="0 0 36 26" fill="none"
                                ...
                                <path
                                    ...
                                    fill="var(--blue)" stroke="var(--blue)" strokeWidth="1.4" />
                            </svg>
